...
def modelUnet(num_classes = 2, input_shape= (1,256,192,3)):
    ...
    x2 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x3 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x4 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x5 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x6 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x7 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x8 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x11 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x12 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    x = Activation('relu')(x12)                                              # Добавляем слой Activation
 
    x = Conv2D(256, (3, 3), padding='same')(x)                              # Добавляем Conv2D-слой с 256-нейронами
    x13 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x14 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x15 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    x = Activation('relu')(x15)                                              # Добавляем слой Activation

    x = Conv2D(128, (3, 3), padding='same')(x)                             # Добавляем Conv2D-слой с 128-нейронами
    x16 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x17 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    x = Activation('relu')(x17)                                              # Добавляем слой Activation

    x = concatenate([x, block_2_out]) 
    x = Conv2D(64, (3, 3), padding='same')(x)                              # Добавляем Conv2D-слой с 64-нейронами
    x18 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    x = Activation('relu')(x18)                                              # Добавляем слой Activation

    x = Conv2D(64, (3, 3), padding='same')(x)                              # Добавляем Conv2D-слой с 64-нейронами
    x19 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    ...
    x21 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    x = Activation('relu')(x21)                                              # Добавляем слой Activation

    x = concatenate([x, block_1_out])
    x = Conv2D(32, (3, 3), padding='same')(x)                              # Добавляем Conv2D-слой с 32-нейронами
    x22 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
    x = Activation('relu')(x22)                                              # Добавляем слой Activation

    x = Conv2D(32, (3, 3), padding='same')(x)                              # Добавляем Conv2D-слой с 32-нейронами
    x23 = BatchNormalization()(x)                                            # Добавляем слой BatchNormalization
